...
def split_data(df,train_data_path,test_data_path,split_ratio,random_state,config):
...
def split_and_saved_data(config_path):
    ...
    split_data(raw_df,train_data_path,test_data_path,split_ratio,random_state,config)
